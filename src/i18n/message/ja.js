const ja = {
  ...
  "message": {
    ...
    "Do you want to send a test notification?": "テスト通知を送信してよろしいですか?",
  },
  "error": {
  ...
  "view": {
    ...
    "alert": {
      ...
      "Currently, the following webhook URL (masked) is registered. If webhook_url is blank when editing, it will be not updated.": "現在、以下のウェブフックURL（マスク表示）が登録されています。空のまま編集ボタンを押した場合、登録済みのURLは更新されません。",
