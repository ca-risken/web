const en = {
  btn: {
    ...
    'DOWNLOAD REPORT (ORGANIZATION)': 'DOWNLOAD REPORT (ORGANIZATION)',
  ...
  action: {
    ...
    'Enable CodeScan': 'Enable CodeScan',
  ...
  message: {
    ...
    'Accept organization invitation confirm':
      'Do you want to accept the invitation to organization "{name}"?',
    'Reject organization invitation confirm':
      'Do you want to reject the invitation to organization "{name}"?',
    'Accepted organization invitation':
      'Accepted invitation to organization "{name}".',
    'Rejected organization invitation':
      'Rejected invitation to organization "{name}".',
  },
  error: {
