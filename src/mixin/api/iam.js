const iam = {
  ...
  methods: {
    ...
    async isAdminAPI(userID) {
      const res = await this.$axios.get('/iam/is-admin/?user_id=' + userID).catch((err) => {
        return Promise.reject(err)
      })
    ...
    async listAdminRoleAPI(name) {
      const res = await this.$axios.get(
        "/admin/list-admin-role/?name=" + name
      ).catch((err) => {
        return Promise.reject(err)
      })
      if (!res.data.data.role_id) {
    ...
    async getRoleAPI(roleID) {
      const res = await this.$axios.get(
        "/iam/get-role/?project_id=" + this.$store.state.project.project_id + "&role_id=" + roleID
      ).catch((err) => {
        return Promise.reject(err)
      })
    ...
    async getAdminRoleAPI(roleID) {
      const res = await this.$axios.get(
        "/admin/get-admin-role/?role_id=" + roleID
      ).catch((err) => {
        return Promise.reject(err)
      })
      return res.data.data.role
    ...
    async putRoleAPI(name) {
      ...
      const res = await this.$axios.post("/iam/put-role/", roleParam).catch((err) => {
        return Promise.reject(err)
      })
      return res.data.data.role
    },
    async attachRoleAPI(userID, roleID) {
      ...
      const res = await this.$axios.post('/iam/attach-role/', param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    async attachAdminRoleAPI(userID, roleID) {
      ...
      const res = await this.$axios.post('/admin/attach-admin-role/', param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    async detachRoleAPI(userID, roleID) {
      ...
      const res = await this.$axios.post('/iam/detach-role/', param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    async detachAdminRoleAPI(userID, roleID) {
      ...
      const res = await this.$axios.post('/admin/detach-admin-role/', param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    async deleteRoleAPI(roleID) {
      ...
      const res = await this.$axios.post("/iam/delete-role/", param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    ...
    async getPolicyAPI(policyID) {
      const res = await this.$axios.get(
        "/iam/get-policy/?project_id=" + this.$store.state.project.project_id + "&policy_id=" + policyID
      ).catch((err) => {
        return Promise.reject(err)
      })
    ...
    async attachPolicyAPI(roleID, policyID) {
      ...
      const res = await this.$axios.post('/iam/attach-policy/', param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    async detachPolicyAPI(roleID, policyID) {
      ...
      const res = await this.$axios.post('/iam/detach-policy/', param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
    async deletePolicyAPI(policyID) {
      ...
      const res = await this.$axios.post("/iam/delete-policy/", param).catch((err) => {
        return Promise.reject(err)
      })
      return res
    },
