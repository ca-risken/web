...
const diagnosis = {
  ...
  methods: {
    ...
    async putWPScanSettingAPI(wpscan_setting_id, target_url, options, scan_at) {
      ...
      await this.$axios
        .post('/diagnosis/put-wpscan-setting/', param)
        .catch((err) => {
    ...
    async deleteWPScanSettingAPI(wpscan_setting_id) {
      ...
      await this.$axios
        .post('/diagnosis/delete-wpscan-setting/', param)
        .catch((err) => {
          this.finishError(err.response.data)
          return Promise.reject(err)
        })
    ...
    async putPortscanSettingAPI(
      diagnosisDataSourceID,
      portscanSettingID,
      name,
      target
    ) {
      ...
      const res = await this.$axios
        .post('/diagnosis/put-portscan-setting/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      var newPortscanSettingID =
        res.data.data.portscan_setting.portscan_setting_id
      const k = /,|\n| /
      const targets = target.split(k)
      targets.forEach((element) =>
        this.putPortscanTargetAPI(newPortscanSettingID, 0, element)
      )
      return res
    },
    async deletePortscanSettingAPI(portscanSettingID) {
      ...
      const res = await this.$axios
        .post('/diagnosis/delete-portscan-setting/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
    ...
    async putPortscanTargetAPI(portscanSettingID, portscanTargetID, target) {
      ...
      const res = await this.$axios
        .post('/diagnosis/put-portscan-target/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
    ...
    async deletePortscanTargetAPI(portscanTargetID) {
      ...
      const res = await this.$axios
        .post('/diagnosis/delete-portscan-target/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
    ...
    async putApplicationScanAPI(
      diagnosisDataSourceID,
      applicationScanSettingID,
      name,
      scanType
    ) {
      const param = {
      ...
      const res = await this.$axios
        .post('/diagnosis/put-application-scan/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      var newApplicationScanID =
        res.data.data.application_scan.application_scan_id
    ...
    async deleteApplicationScanAPI(applicationScanSettingID) {
      ...
      const res = await this.$axios
        .post('/diagnosis/delete-application-scan/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
    ...
    async putApplicationScanBasicSettingAPI(
      applicationScanSettingID,
      applicationScanBasicSettingID,
      target,
      max_depth,
      max_children
    ) {
      ...
      const res = await this.$axios
        .post('/diagnosis/put-application-scan-basic-setting/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
    ...
    async deleteApplicationScanBasicSettingAPI(applicationScanBasicSettingID) {
      ...
      const res = await this.$axios
        .post('/diagnosis/delete-application-scan-basic-setting/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
    ...
    async invokeDiagnosisScanAPI(setting_id, diagnosis_data_source_id) {
      ...
      const res = await this.$axios
        .post('/diagnosis/invoke-scan/', param)
        .catch((err) => {
          return Promise.reject(err)
        })
      return res
